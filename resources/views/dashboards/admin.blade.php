    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                <a href="{{ url('/students') }}" class="bg-white/80 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-white/5 shadow-sm rounded-2xl p-5 hover:shadow-md hover:border-zinc-300 dark:hover:border-white/10 hover:scale-[1.01] transition-all duration-200 flex items-center gap-4 group">
                ...
                <a href="{{ url('/hafalan-targets') }}" class="bg-white/80 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-white/5 shadow-sm rounded-2xl p-5 hover:shadow-md hover:border-zinc-300 dark:hover:border-white/10 hover:scale-[1.01] transition-all duration-200 flex items-center gap-4 group">
                ...
                <a href="{{ route('adab.index') }}" class="bg-white/80 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-white/5 shadow-sm rounded-2xl p-5 hover:shadow-md hover:border-zinc-300 dark:hover:border-white/10 hover:scale-[1.01] transition-all duration-200 flex items-center gap-4 group">
                ...
                <a href="{{ url('/reports') }}" class="bg-white/80 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-white/5 shadow-sm rounded-2xl p-5 hover:shadow-md hover:border-zinc-300 dark:hover:border-white/10 hover:scale-[1.01] transition-all duration-200 flex items-center gap-4 group">
