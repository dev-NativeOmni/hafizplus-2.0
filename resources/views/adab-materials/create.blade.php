        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-bold leading-tight text-gray-900 dark:text-white">
                    Tambah Materi Adab Baru
                </h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-zinc-400">
                    Unggah materi pelajaran adab berupa dokumen atau tautan link luar.
                </p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-2xl border border-gray-250 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm p-6">
                ...
                <form method="POST" action="{{ route('adab-materials.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- File Upload -->
                        <div>
                            <label for="file" class="block text-xs font-bold text-gray-750 dark:text-zinc-300 uppercase tracking-wider mb-2">Upload File Dokumen</label>
                            <input type="file"
                                   id="file"
                                   name="file"
